...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cart_status: Schema.Attribute.Enumeration<['active', 'completed']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dining_preference: Schema.Attribute.Enumeration<['takeaway', 'dine-in']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPbAdminUserPbAdminUser extends Struct.CollectionTypeSchema {
  collectionName: 'pb_admin_users';
  info: {
    displayName: 'PB Admin User';
    pluralName: 'pb-admin-users';
    singularName: 'pb-admin-user';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pb-admin-user.pb-admin-user'
    > &
      Schema.Attribute.Private;
    Password: Schema.Attribute.Password;
    publishedAt: Schema.Attribute.DateTime;
    Role: Schema.Attribute.Enumeration<['admin', 'manager']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Username: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pb-admin-user.pb-admin-user': ApiPbAdminUserPbAdminUser;
